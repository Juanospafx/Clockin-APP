// src/pages/User/admin/components/ProjectHistoryHeader.tsx
import React, { ChangeEvent } from "react";

export interface ProjectHistoryHeaderProps {
  searchTerm: string;
...
const ProjectHistoryHeader: React.FC<ProjectHistoryHeaderProps> = ({
  searchTerm,
  onSearchChange,
  onExportExcel,
  onToggleSidebar,
  ...
  return (
    <header className="sticky top-0 z-10 bg-white border-b border-gray-200 px-4 py-4 lg:px-16 lg:py-6">
      <div
        className="
          grid
