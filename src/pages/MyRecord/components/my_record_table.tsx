          ...
          {entries.length > 0 ? (
            entries.map(e => (
              <tr key={e.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-sm text-gray-700">{e.projectName}</td>
                <td className="px-4 py-3 text-sm text-gray-700">{e.address}</td>
                <td className="px-4 py-3 text-sm text-gray-700 text-right">{e.date}</td>
